    ...
    const cardsData = [
        {
            ...
            lists: ['Dedicated merchant accounts', 'Multiple payment acceptance methods', 'Next-day merchant funding', 'Advanced merchant terminals', 'Mobile merchant solutions']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Merchant Support',
            lists: ['24/7 merchant assistance', 'Dedicated account manager', 'Merchant account monitoring', 'Merchant account monitoring', 'Chargeback management']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Merchant Tools',
            lists: ['Merchant account dashboard', 'Transaction reporting', 'Customer management', 'Revenue analytics', 'Accounting integration', 'Business insights']
        }
    ]
