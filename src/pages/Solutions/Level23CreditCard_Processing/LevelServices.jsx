...
function LevelServices() {

    const cardsData = [
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Enhanced Data Capture',
            lists: ['Automated Level 2 & 3 data collection', 'Customizable data fields', 'Integration with existing systems', 'Real-time data validation', 'Support for multiple data formats', 'Secure data transmission']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Cost Reduction',
            lists: ['Lower interchange rates', 'Reduced processing fees', 'Optimized B2B transactions', 'Improved cash flow management', 'Enhanced reconciliation process', 'Streamlined expense tracking']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Reporting & Analytics',
            lists: ['Detailed transaction reports', 'Customizable dashboards', 'Spend analysis tools', 'Compliance monitoring', 'Trend identification', 'Performance benchmarking']
        }
    ]
