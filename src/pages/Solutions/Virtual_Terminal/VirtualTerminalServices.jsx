...
function VirtualTerminalServices() {

    const cardsData = [
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Virtual Terminal Services',
            lists: ['Credit and debit card processing', 'ACH and eCheck payments', 'Recurring billing setup', 'Customizable payment fields', 'Multi-user access with role-based permissions', 'Batch processing capabilities']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Flexible Accessibility',
            lists: ['Cloud-based solution accessible from anywhere', 'Mobile-responsive design', 'Integration with existing systems', 'Support for multiple currencies', 'Real-time transaction updates', '24/7 availability']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Enhanced Security',
            lists: ['PCI DSS compliance', 'Tokenization of sensitive data', 'Address Verification Service (AVS)', 'Card Verification Value (CVV) checks', 'Fraud screening tools', 'Secure user authentication']
        }
    ]
...
export default VirtualTerminalServices