    ...
    const cardsData = [
        {
            ...
            title: 'Versatile Mobile Solutions',
            lists: ['Support for major mobile wallets (Apple Pay, Google Pay, Samsung Pay)', 'In-app payment integration', 'Mobile point-of-sale (mPOS) systems', 'QR code payment options', 'NFC (Near Field Communication) technology support', 'SMS payment capabilities']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Seamless User Experience',
            lists: ['One-click checkout options', 'Biometric authentication support', 'Cross-platform compatibility', 'Customizable UI/UX for branded experiences', 'Real-time transaction notifications', 'Digital receipt generation']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Enhanced Security',
            lists: ['End-to-end encryption', 'Tokenization for sensitive data protection', 'Fraud detection and prevention', 'PCI DSS compliance', 'Two-factor authentication options', 'Secure cloud-based transaction storage']
        }
    ]
