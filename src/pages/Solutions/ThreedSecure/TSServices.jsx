    ...
    const cardsData = [
        {
            ...
            lists: ['Additional layer of authentication', 'Reduced risk of fraudulent transactions', 'Improved customer trust', 'Compliance with PSD2 regulations', 'Real-time risk assessment', 'Frictionless authentication flow']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Chargeback Protection',
            lists: ['Liability shift to card issuer', 'Reduced chargeback rates', 'Lower operational costs', 'Improved merchant reputation', 'Increased authorization rates', 'Better risk management']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Integration & Support',
            lists: ['Easy integration with existing systems', 'Support for major card networks', 'Mobile-friendly authentication', 'Customizable user experience', '24/7 technical support', 'Regular security updates']
        }
    ]
