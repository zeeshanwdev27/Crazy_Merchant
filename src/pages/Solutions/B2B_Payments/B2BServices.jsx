    ...
    const cardsData = [
        {
            ...
            title: 'B2B Merchant Accounts',
            lists: ['20+ Proven Bank Relationships', 'Medium/High Risk Accounts', 'Fast B2B Account Approval', 'Large Merchant Case Studies', 'E-Commerce and Retail B2B', 'B2B B2B Vendors Supported']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Multiple Payment Solutions',
            lists: ['Multiple E-Commerce Gateway', 'Chargeback Prevention', 'ACH', 'E-Check', 'Credit Cards', 'B2B-Level II/III Data Discounts','3D Secure Frictionless Checkout','Mobile Payment','EMV Readers']
        },
                {
