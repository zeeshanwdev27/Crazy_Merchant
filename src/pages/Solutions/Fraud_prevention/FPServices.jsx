    ...
    const cardsData = [
        {
            ...
            lists: ['Advanced encryption protocols', 'Real-time transaction monitoring', 'Machine learning-based risk scoring', 'Device fingerprinting', 'Behavioral analytics', 'IP geolocation and velocity checks']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Intelligent Detection',
            lists: ['Pattern recognition algorithms', 'Anomaly detection systems', 'Historical data analysis', 'Cross-merchant fraud detection', 'Industry-specific risk models', 'Customizable rule sets']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Adaptive AI Solutions',
            lists: ['Self-learning fraud detection models', 'Continuous model retraining', 'Predictive fraud analytics', 'Automated risk assessment', 'Dynamic threshold adjustments', 'Fraud trend forecasting']
        }
    ]
