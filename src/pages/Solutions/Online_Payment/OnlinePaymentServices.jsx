...
function OnlinePaymentServices() {

    const cardsData = [
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Comprehensive E-commerce Solutions',
            lists: ['Integration with major e-commerce platforms', 'Support for multiple payment gateways', 'Recurring billing and subscription management', 'Virtual terminal for manual entry transactions', 'Customizable checkout experiences']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Advanced Security Measures',
            lists: ['PCI DSS Level 1 compliance', 'Tokenization and encryption of sensitive data', '3D Secure authentication', 'Fraud detection and prevention tools', 'Address Verification Service (AVS)', 'Card Verification Value (CVV) checks']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Optimized Performance',
            lists: ['Fast transaction processing times', 'High uptime and reliability', 'Real-time transaction monitoring', 'Automated reconciliation and reporting', 'Mobile-responsive payment pages', 'API access for custom integrations']
        }
    ]
