...
function MotoServices() {

    const cardsData = [
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Secure Processing',
            lists: ['PCI DSS compliance', 'Fraud prevention tools', 'Secure data transmission', 'CVV verification', 'Address verification (AVS)', 'real-time transaction monitoring']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Payment Solutions',
            lists: ['Virtual terminals', 'Recurring billing options', 'Multiple payment methods', 'Batch processing', 'Quick transaction approval', 'Customizable payment forms']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Business Tools',
            lists: ['Detailed reporting', 'Customer management', 'Invoice generation', 'Transaction history', 'Analytics dashboard', 'Integration capabilities']
        }
    ]
