    ...
    const cardsData = [
        {
            ...
            lists: ['Advanced fraud detection algorithms', 'Real-time transaction monitoring', 'Customizable risk scoring', 'IP geolocation and velocity checks', 'Device fingerprinting', 'Machine learning-based fraud analysis']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Chargeback Reduction',
            lists: ['Automated chargeback alerts', 'Dispute resolution assistance', 'Chargeback reason code analysis', 'Customer communication templates', 'Refund and cancellation management', 'Best practices implementation']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Performance Analytics',
            lists: ['Comprehensive chargeback reporting', 'Trend analysis and forecasting', 'Merchant account health monitoring', 'Industry benchmarking', 'ROI tracking on prevention efforts', 'Customizable dashboards and alerts']
        }
    ]
