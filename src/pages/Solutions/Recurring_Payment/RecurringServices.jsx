    ...
    const cardsData = [
        {
            ...
            lists: ['Custom billing cycles (daily, weekly, monthly, annually)', 'Variable amount billing', 'Trial period management', 'Proration handling', 'Multi-plan and tier support', 'Automatic retry logic for failed payments']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Advanced Management Tools',
            lists: ['Customer self-service portal', 'Subscription lifecycle management', 'Dunning management', 'Upgrade/downgrade handling', 'Pause and resume functionality', 'Cancellation flow optimization']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Insights and Reporting',
            lists: ['Real-time subscription analytics', 'Revenue forecasting', 'Churn prediction and analysis', 'Customizable reporting dashboards', 'Integration with business intelligence tools', 'Subscription health monitoring']
        }
    ]
