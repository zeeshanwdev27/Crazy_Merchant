...
function ACHServices() {

    const cardsData = [
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Cost-Effective Transactions',
            lists: ['Lower processing fees than credit cards', 'Reduced transaction costs for high-volume businesses', 'No credit card interchange fees', 'Ideal for recurring payments', 'Simplified billing process', 'Improved cash flow management']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Enhanced Security',
            lists: ['Bank-level encryption and security measures', 'Reduced risk of fraud compared to paper checks', 'Compliance with NACHA regulations', 'Secure storage of sensitive financial data', 'Multi-factor authentication options', 'Real-time transaction monitoring']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Streamlined Operations',
            lists: ['Faster settlement times than traditional checks', 'Automated reconciliation process', 'Integration with existing accounting systems', 'Detailed reporting and analytics', 'Scalable solution for growing businesses', 'Support for both one-time and recurring payments']
        }
    ]
