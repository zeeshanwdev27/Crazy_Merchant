...
function TechSupportPaymentGateways() {
  ...
  return (
    <div className="bg-[url('/CallCenters/PaymentGateways/background.png')] bg-center lg:bg-top lg:bg-cover bg-no-repeat overflow-hidden sm:h-[150vh] lg:h-[165vh] py-10 lg:py-30 px-5 md:px-20 lg:px-40 mx-auto">
        ...
        <div className='flex flex-col items-center w-full max-w-7xl font-medium mx-auto text-center text-white gap-15'>
            ...
            <div className='flex flex-col gap-5 w-full max-w-5xl'>
                <h1 className='text-4xl sm:text-5xl'>Set Up <span className='text-[#F29200]'>Secure Payment</span> Gateways for <span className='text-[#F29200]'>Tech Support Businesses</span></h1>
    ...
    <button className='nextBtn p-2.5 rounded-full bg-[#F29200]'>
        ...
        <div className='flex flex-col items-center w-full max-w-7xl font-medium mx-auto text-center text-white gap-15 py-20'>
            ...
            <div className='flex flex-col gap-5 w-full max-w-5xl'>
                <h1 className='text-4xl sm:text-5xl'>Seamless <span className='text-[#F29200]'>Payment</span> Processing for<br /> <span className='text-[#F29200]'>Tech Support Businesses</span></h1>
                <p className='text-sm sm:text-lg'>Whether you run a small remote repair team or a large-scale international technical support operation, we ensure:</p>
            </div>
...
export default TechSupportPaymentGateways
