    ...
    const cardsData = [
        {
            ...
            title: 'Travel Merchant Accounts',
            lists: ['20+ Proven Bank Relationships', 'Medium/High Risk Accounts', 'Fast Travel Account Approval', 'Large Merchant Case Studies', 'E-Commerce and Retail Travel', 'B2B Travel Vendors Supported']
        },
        {
            url : '/Home/PaymentSolutions/card.png',
            title: 'Multiple Payment Solutions',
            lists: ['Multiple E-Commerce Gateway', 'Chargeback Prevention', 'ACHl', 'E-Check', 'Credit Cards', 'B2B-Level II/III Data Discounts', '3D Secure Frictionless Checkout', 'Mobile Payment', 'EMV Readers']
        },
                {
             url : '/Home/PaymentSolutions/support.png',
            title: 'Compatibility & Support',
            lists: ['Gateway Recurring Billing', 'Vault', 'E-Commerce Cart Plugins', 'Developer API / Docs', 'POS/Terminals', 'Scalable Merchant Accounts', 'Dedicated Account Managers']
        }
    ]
