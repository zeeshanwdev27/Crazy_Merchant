...
function CallCenterReadyToStart() {
  return (
    <div className="bg-[url('/CallCenters/ReadyToStart/Section.png')] bg-cover bg-no-repeat bg-center overflow-hidden h-full py-10 lg:py-30 px-4 sm:px-5 md:px-20 lg:px-40 mx-auto">
