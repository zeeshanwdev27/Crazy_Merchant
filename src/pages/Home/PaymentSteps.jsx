...
function PaymentSteps() {
  return (
    <div className='h-full min-h-[66vh]'>
        ...
        <div className='lg:px-25 ml-10 md:ml-0'>

        <div className='grid md:grid-cols-2 lg:grid-cols-4 md:justify-center gap-5 mx-auto w-full'>


        {/* Payment Gateways */}
        <div className='flex flex-col gap-4 border border-gray-200 rounded-2xl w-full max-w-xs justify-center items-center bg-[#FAFAFA] shadow py-8'>
