    ...
    if (window.LiveChatWidget) {
      window.LiveChatWidget.call("maximize");
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-1 justify-center w-full'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/travel')}>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/techsupport')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/callcenters')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/outbound')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/medical')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/ecommerce-websites')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <div className='flex justify-center cursor-pointer' onClick={()=> navigate('/digitalbooks')}>
              <div className='bg-white hover:bg-amber-500 hover:text-white w-full max-w-xs flex flex-col gap-4 justify-center items-center rounded-3xl group py-5'>
            ...
            <Link to={'/faqs'} className='relative flex justify-center cursor-pointer group col-span-2 md:col-span-1'>
              <img src="/Home/GetStarted/ViewIndustries.png" alt="ViewIndustries" className='w-80 h-40 md:w-40 md:h-35 lg:w-80 lg:h-50' />
             
                <h1 className='absolute left-15 md:left-8 lg:left-10 top-3 md:top-5 lg:top-3 text-3xl md:text-xl lg:text-4xl text-white'>Any <br /> Questions?</h1>
